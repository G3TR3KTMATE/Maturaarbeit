...
# Die Zahl s wird dabei kopiert, weile diese in der while schlefie verändert wird und man die Originalzahl im unteren Teil braucht

# Die 2 print Funktionen sind wieder nur für die überprüfung -- im jetzigen Standpunkt funktioniert etwas in der Enschlüsslung nicht - die Liste wird nie länger als 2 Zahlen :/

# Durch y wird jeder Buchstabe mit %256 zurückverfolgt und der Liste angesetzt
...
# Sie gerunden Zahlen sind im Programm nicht nötig aber damit möchte ich meine ursprüngliche Lösung demonstrieren.
...
# Zuerst habe ich das Programm hier geschrieben und das beim Ausführen des Richtigen Programmes nicht dieser Code ausgeführt wird, steht dieser in dieser if funktion
# Nur wenn ich mich auf dieser Seite befinde und das Programm von hier aus starte, wird dieser Code auch ausgeführt
